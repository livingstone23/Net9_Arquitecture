...
public class CustomersController : ControllerBase
{
    ...
    public async Task<IActionResult> UpdateAsync([FromRoute] string customerId, [FromBody] CustomerDto customerDto)
    {
        ...
        var foundCustomerResponse = await _customersApplication.GetAsync(customerId);
        if (!foundCustomerResponse.IsSuccess || foundCustomerResponse.Data == null)
            return NotFound(foundCustomerResponse.Message);
